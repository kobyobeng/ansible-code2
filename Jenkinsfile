    ...
    stages{
        ...
        stage('Publish to ansible server'){
            steps{
                ...
                false, excludes: '', execCommand: 'unzip ansible-${BUILD_ID}.zip; sudo rm -rf ansible-${BUILD_ID}.zip', execTimeout: 1200000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: \
